...
if ( !function_exists( 'sc_fs' ) ) {
     ...
     */
    define( 'SearchConsole_VERSION', '1.1.0' );
    ...
    function sc_fs_custom_connect_message_on_update(
        ...
        return sprintf(
            __( 'Hey %1$s' ) . ',<br>' .
            __( 'Please help us improve %2$s! If you opt-in, some data about your usage of %2$s will be sent to %5$s. If you skip this, that\'s okay! %2$s will still work just fine.', 'search-console' ),
            $user_first_name,
            '<b>' . $plugin_title . '</b>',
            '<b>' . $user_login . '</b>',
            $site_link,
    ...
    sc_fs()->add_filter( 'connect_message_on_update', 'sc_fs_custom_connect_message_on_update', 10, 6);
