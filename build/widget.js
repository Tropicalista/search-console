...
/* harmony import */ var _chart__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./chart */ "./src/widget/chart.js");
...
const Widget = () => {
  ...
  if (!settings?.site || !settings?.credentials?.client_secret || !settings?.credentials?.client_id || !settings.token.refresh_token) {
    ...
    (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('<p>You need to authenticate and set a site on <a href="%s">settings page</a>.</p>', 'formello'), (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_4__.addQueryArgs)('admin.php', {
      page: 'search-console-settings'
    }))));
  }
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_chart__WEBPACK_IMPORTED_MODULE_5__.MyChart, null), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.RawHTML, null, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)( /* translators: Developer console url. */
  (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('More data on <a href="%s">Search Console dashboard</a>.', 'formello'), (0,_wordpress_url__WEBPACK_IMPORTED_MODULE_4__.addQueryArgs)('admin.php', {
    page: 'search-console'
  }))));
};
