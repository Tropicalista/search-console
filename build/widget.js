...
/* harmony export */   "chartOptions": function() { return /* binding */ chartOptions; }
/* harmony export */ });
const chartOptions = {
  width: '100%',
  height: '400',
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "loadGoogleScript": function() { return /* binding */ loadGoogleScript; }
/* harmony export */ });
const loadGoogleScript = () => {
  // Loads the Google JavaScript Library
  (function () {
    const id = 'google-js';
    const src = 'https://apis.google.com/js/platform.js'; // We have at least one script 

    const firstJs = document.getElementsByTagName('script')[0]; // Prevent script from loading twice
...
function selectHandler() {
  ...
  var selection = chart.getSelection(); // click and data index are one off

  var i = selection[0].column - 1;
  _chartOptions__WEBPACK_IMPORTED_MODULE_1__.chartOptions.series[i].tooltip = !_chartOptions__WEBPACK_IMPORTED_MODULE_1__.chartOptions.series[i].tooltip; // just simple reverse
