 ...
 */
class MultipartStream implements \Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface
{
    ...
    {
        $stream = new \Tropicalista\SearchConsole\GuzzleHttp\Psr7\AppendStream();
    ...
    private function addElement(\Tropicalista\SearchConsole\GuzzleHttp\Psr7\AppendStream $stream, array $element)
    {
     ...
     * @return array
     */
    private function createElement($name, \Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface $stream, $filename, array $headers)
    {
