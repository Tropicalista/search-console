...
class StreamWrapper
{
     ...
     */
    public static function getResource(\Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface $stream)
    {
        self::register();
     ...
     * @return resource
     */
    public static function createStreamContext(\Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface $stream)
    {
