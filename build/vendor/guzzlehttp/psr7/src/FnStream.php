 ...
 */
class FnStream implements \Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface
{
    /** @var array */
    private $methods;
     ...
     * @return FnStream
     */
    public static function decorate(\Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface $stream, array $methods)
    {
