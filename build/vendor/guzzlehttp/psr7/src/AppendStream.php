 ...
 */
class AppendStream implements \Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface
{
     ...
     */
    public function addStream(\Tropicalista\SearchConsole\Psr\Http\Message\StreamInterface $stream)
    {
