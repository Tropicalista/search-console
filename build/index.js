...
function PostTypeSelection(props) {
  const {
    gapi,
    settings,
    refreshToken,
  ...
  var postTypeOptions = !Array.isArray(postTypes) ? postTypes : postTypes.filter(
...
const SiteSelect = props => {
  ...
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_post_type_selection__WEBPACK_IMPORTED_MODULE_5__["default"], props), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_verification__WEBPACK_IMPORTED_MODULE_4__["default"], props)));
};
...
/* harmony import */ var _utils_menuFix__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/menuFix */ "./src/utils/menuFix.js");
...
/* harmony import */ var _routes_dashboard__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./routes/dashboard */ "./src/routes/dashboard.js");
/* harmony import */ var _routes_settings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./routes/settings */ "./src/routes/settings.js");
...
/* harmony import */ var gapi_script__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! gapi-script */ "./node_modules/gapi-script/index.js");
...
const App = () => {
  var _settings$token;
  const [gapiLoaded, setGapiLoaded] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const {
    settings,
    isReady
  ...
  const loadGapi = () => {
    if (gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi?.client) {
      return;
    }
    gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi?.load('client', async () => {
      await gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi?.client?.load('searchconsole', 'v1').then(() => {
        gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi.client.init({
          token: token
        });
        getSites();
      });
  ...
  const refreshToken = () => {
    _wordpress_api_fetch__WEBPACK_IMPORTED_MODULE_12___default()({
      ...
      gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi.client.setToken(result);
    }).catch(error => {
      console.log(error);
  ...
  const getSites = () => {
    ...
    gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi.client?.webmasters.sites.list().then(s => {
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(React.StrictMode, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_14__.HashRouter, {
    basename: "/"
  }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Header__WEBPACK_IMPORTED_MODULE_10__["default"], {
    title: 'Search Console'
  }), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_15__.Routes, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(react_router_dom__WEBPACK_IMPORTED_MODULE_15__.Route, {
    path: "/",
    element: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_routes_dashboard__WEBPACK_IMPORTED_MODULE_8__["default"], {
      settings: settings
      //gapi={ gapi }
      ,
    ...
    path: "/settings",
    element: (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_routes_settings__WEBPACK_IMPORTED_MODULE_9__["default"], {
      settings: settings,
      gapi: gapi_script__WEBPACK_IMPORTED_MODULE_13__.gapi,
      refreshToken: refreshToken,
      getSites: getSites
    })
  })), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_components_Footer__WEBPACK_IMPORTED_MODULE_11__["default"], null)));
};
...
(0,_utils_menuFix__WEBPACK_IMPORTED_MODULE_5__["default"])('search-console');
...
const Dashboard = props => {
  ...
  if (token && !gapi_script__WEBPACK_IMPORTED_MODULE_8__.gapi?.client) {
  ...
  console.log(gapi_script__WEBPACK_IMPORTED_MODULE_8__.gapi);
