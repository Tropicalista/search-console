...
class DashyGsc_Admin {
	...
	public function enqueue_styles() {
		wp_enqueue_style( $this->plugin_name . '-custom', plugin_dir_url( __FILE__ ) . 'css/dashygsc.css', array(), $this->version, 'all' );
	}
	...
	public function add_plugin_admin_menu() {
		...
		$my_settings = add_options_page( $this->plugin_name, 'Search Console', 'manage_options', $this->plugin_name . 'settings', array($this, 'display_plugin_setup_page') );
		add_action( 'load-' . $my_settings, array($this, 'enqueue_styles') );
	}
	...
	*/
	...
	public function display_plugin_main_page() {
		include_once 'partials/dashygsc-display.php';
	}
	...
	public function display_plugin_setup_page() {
		include_once 'partials/dashygsc-admin-display.php';
	}
	...
	function add_settings() {
	    ...
	    add_settings_field( 
	        ...
	        esc_html__( 'Choose a site', 'dashygsc' ),                           // The label to the left of the option interface element
	...
	function add_advanced_settings() {
	    ...
	    add_settings_section(
	        $this->plugin_name . '_advanced',         // ID used to identify this section and with which to register options
	        '',                  // Title to be displayed on the administration page
	        '', // Callback used to render the description of the section
	        $this->plugin_name . '_advanced'     // Page on which to add this section of options
	    );
	...
	function show_settings(){
		include_once 'partials/dashygsc-settings.php';
	}

	function custom_token(){
		include_once 'partials/dashygsc-advanced.php';
	}
	...
	**/
	...
	function validate_general($input){
		...
		$options = get_option($this->plugin_name . '_general', $this->optionsDefault);
		$token = $options['token'];
	    $valid['site'] = '';
	...
	function reset_all($input){
		if (isset($input['reset'])){
		    delete_option($this->plugin_name . '_general');
		    delete_option($this->plugin_name . '_advanced');
		    $options = [
		        'site' => '',
		        'token' => null
		    ];
		    update_option( $this->plugin_name . '_general', $options );	
		}
		return true;
	}
