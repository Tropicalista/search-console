...
<div class="wrap">
	...
	<h2 class="nav-tab-wrapper">
	    <a href="?page=<? echo $this->plugin_name; ?>-settings&tab=display_options" class="nav-tab <?php echo $active_tab == 'display_options' ? 'nav-tab-active' : ''; ?>"><?php _e('Settings', 'dashygsc'); ?></a>
	    <a href="?page=<? echo $this->plugin_name; ?>-settings&tab=advanced" class="nav-tab <?php echo $active_tab == 'advanced' ? 'nav-tab-active' : ''; ?>"><?php _e('Advanced settings', 'dashygsc'); ?></a>
	</h2>
